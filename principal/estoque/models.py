...
class MercadoLivreAd(models.Model):
    ...
    def __str__(self):
        return f"{self.produto} - {self.mlb_id}"
    def mlb_id_formatado(self):
        # Formata o mlb_id, adicionando o hífen após os primeiros três caracteres
        return f"{self.mlb_id[:3]}-{self.mlb_id[3:]}"
